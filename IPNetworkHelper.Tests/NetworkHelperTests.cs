...
namespace IPNetworkHelper.Tests
{
    ...
    public class NetworkHelperTests
    {
        ...
        {
            var network = NetworkHelper.Parse("192.168.0.0/16");
            var desired = new[] { "192.168.239.252/30", "192.168.228.0/24", "192.168.174.0/24" }.Select(v => NetworkHelper.Parse(v)).ToArray();
        ...
        {
            var network = NetworkHelper.Parse("192.168.0.0/16");
            var desired = new[] { "192.168.239.252/30", "192.168.228.0/24", "10.10.5.0/24" }.Select(v => NetworkHelper.Parse(v)).ToArray();
